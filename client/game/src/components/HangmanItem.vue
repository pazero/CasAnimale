<template>
    <div id="hangman">
      ...
      <vs-popup v-if="gameOver" class="holamundo"  title="Lorem ipsum dolor sit amet" :active.sync="popupActivo">
        <p>GAME OVER</p>
    ...
    export default {
      ...
      data: function () {
        return {
          ...
          initialized: false,
          wordBank: ['CANARY', 'ZEBRA', 'ELEPHANT', 'DOGS', 'CAT', 'LION', 'GIRAFFE', 'ZOO', 'PUPPY', 'PETS', 'COBRA', 'PYTHON', 'MONKEY'],
          gameOver: false
        }
      },
      methods: {
